...
class MetaDraftGUI(QWidget):
    ...
    metadraft_rpt_footer = '<p><small>Generated by MetaDraft {} &copy; <a href="https://github.com/SystemsBioinformatics/metadraft">MetaToolkit</a>.</small></p>'.format(__version__)
